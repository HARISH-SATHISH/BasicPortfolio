...
function Skill(){
  ...
  <div className="container px-5 py-12 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-gray-800 text-indigo-400 mb-4 text-2xl">
          <LiaJava/>
          </div>
          <h2 className="text-lg text-white font-medium title-font mb-2"></h2>
